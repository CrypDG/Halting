...
| `apps/admin` | Next.js ops panel — verification queue, drivers, trips, live ops, fees, pricing | `npm run dev -w @acting/admin` → http://localhost:3100 |
...
- `admin@acting.dev` — super admin
- `customer@acting.dev` — KYC-verified customer
- `driver1@acting.dev` — approved car driver (LMV), T Nagar Chennai
- `driver2@acting.dev` — approved heavy-vehicle driver (HMV+HTV+PSV → truck, bus, crane, earth mover)
- `driver3@acting.dev` — school-bus driver
